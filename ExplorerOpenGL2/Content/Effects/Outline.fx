...
float2 thickness = float2(0.0f, 0.0f);
...
float4 MainPS(VertexShaderOutput input) : COLOR
{
    ...
    pos = float2(input.TextureCoordinates.x - thickness.x, input.TextureCoordinates.y);
    ...
    pos = float2(input.TextureCoordinates.x, input.TextureCoordinates.y - thickness.y);
